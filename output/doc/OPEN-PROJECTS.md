...
This is the index for the repo's `output/doc` workshop drawer.

Use this file to keep active draft artifacts visible so book work, presentation
drafts, research notes, and document experiments do not fall through the cracks.

## Agent Rule

When helping Robert find a document in this folder, also check this index and
surface any active file that appears stale, misplaced, or ready for the next
step.

Use plain language:

> I found the document you were looking for. While I was in the drawer, I also
> noticed this active draft has not been touched in a while.

Do not derail urgent work. Just name the loose thread and suggest a next action.
...
- `Startup Operational Excellence-working manuscript ch1-3.docx`
  - Previous assembled manuscript through Chapter 3.
- `Startup Operational Excellence-working manuscript ch1-4.docx`
  - Previous assembled manuscript through Chapter 4.
- `Startup Operational Excellence-working manuscript ch1-5.docx`
  - Previous assembled manuscript through Chapter 5.
- `Startup Operational Excellence-working manuscript ch1-6.docx`
  - Previous assembled manuscript through Chapter 6.
- `Startup Operational Excellence-working manuscript ch1-7.docx`
  - Previous assembled manuscript through Chapter 7.
...
- `Startup Operational Excellence-Chapter 1 expanded Sam draft.docx`
  - Expanded Chapter 1 draft.
- `Startup Operational Excellence-Chapter 2 expanded Sam draft.docx`
  - Expanded Chapter 2 draft.
- `Startup Operational Excellence-Chapter 3 expanded Sam draft.docx`
  - Expanded Chapter 3 draft.
- `Startup Operational Excellence-Chapter 4 expanded Sam draft.docx`
  - Expanded Chapter 4 draft with the Bootstrap Limit Wall lesson.
- `Startup Operational Excellence-Chapter 4 expanded Sam draft.md`
  - Markdown source for Chapter 4 draft.
- `Startup Operational Excellence-Chapter 5 expanded Sam draft.docx`
  - Expanded Chapter 5 draft.
- `Startup Operational Excellence-Chapter 5 expanded Sam draft.md`
  - Markdown source for Chapter 5 draft.
- `Startup Operational Excellence-Chapter 6 expanded Sam draft.docx`
  - Expanded Chapter 6 draft.
- `Startup Operational Excellence-Chapter 6 expanded Sam draft.md`
  - Markdown source for Chapter 6 draft.
- `Startup Operational Excellence-Chapter 7 expanded Sam draft.docx`
  - Expanded Chapter 7 draft.
- `Startup Operational Excellence-Chapter 7 expanded Sam draft.md`
  - Markdown source for Chapter 7 draft.
- `Startup Operational Excellence-Chapter 8 expanded Sam draft.docx`
  - Expanded Chapter 8 draft.
- `Startup Operational Excellence-Chapter 8 expanded Sam draft.md`
  - Markdown source for Chapter 8 draft.
- `Startup Operational Excellence-Conclusion Sam draft.docx`
...
- `Startup Operational Excellence-voice-sample.docx`
  - Voice sample / style calibration artifact.
- `Startup Operational Excellence-narrative-draft.docx`
  - Early narrative draft.

## Maintenance

- Update this index when a new active document project enters `output/doc`.
- Mark a project `Dormant` if no one has touched it in 14 days but it still
  matters.
- Move or archive finished drafts only after the final location is clear.
- Do not overwrite source manuscripts; create versioned working files instead.
