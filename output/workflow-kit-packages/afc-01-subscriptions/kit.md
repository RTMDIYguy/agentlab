---
schema: kit/1.0
slug: afc-01-subscriptions
title: "AFC-01 - Subscriptions"
summary: "AfterCare workflow package for Subscriptions. Consolidates registry metadata, imported source references, setup guidance, validation notes, and automation blueprints into one operative kit file."
version: 0.1.0-draft
...
primaryOwner: "Destiny/Keisha + Robert"
trigger: "New subscriber checkout via Stripe"
cycleTime: "Renewals: automated; at-risk: 14-21 days ahead"
...
Run the Subscriptions workflow for AfterCare with a repeatable trigger, owner, cycle time, outputs, and validation path. The current draft is strong enough for agent orientation and controlled internal use; certification still requires a live run or documented manual evidence.

## When to Use

Use this workflow when the trigger occurs: **New subscriber checkout via Stripe**.
...
| Owner | Destiny/Keisha + Robert |
| Trigger | New subscriber checkout via Stripe |
| Cycle time | Renewals: automated; at-risk: 14-21 days ahead |
...
1. Confirm the trigger: New subscriber checkout via Stripe.
...
| `automation/AFC01-Blueprint.json` | Retained provenance/input artifact now referenced by this consolidated kit. |
| `trackers/AFC-01_Subscription_Tracker.xlsx` | Retained provenance/input artifact now referenced by this consolidated kit. |
...
````markdown
# AFC-01 - Subscriptions Department Source
...
### automation/AFC01-Blueprint.json

````json
{
  "name": "AFC01: Subscriptions (Make.com Blueprint)",
  "flow": [
    {
      "id": 1,
    ...
    },
    {
      ...
      "mapper": {
        "messages": [
          {
            "role": "system",
            "content": "Generate a personalized thank-you and subscription summary."
          }
        ]
      }
    },
...
- `trackers/AFC-01_Subscription_Tracker.xlsx`: binary attachment retained outside the Markdown kit; convert to CSV/Markdown during certification if the sheet contents become authoritative.

## Automation Blueprint

### AFC01-Blueprint.json
