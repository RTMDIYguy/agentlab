---
schema: kit/1.0
slug: cul-08-tech-and-it
title: "CUL-08 - Tech and IT"
summary: "Culture workflow package for Tech and IT. Consolidates registry metadata, imported source references, setup guidance, validation notes, and automation blueprints into one operative kit file."
version: 0.1.0-draft
...
primaryOwner: "Robert + Tech Lead"
trigger: "Immediate agency setup; monthly thereafter"
cycleTime: "Registry: monthly; audit: December"
...
Run the Tech and IT workflow for Culture with a repeatable trigger, owner, cycle time, outputs, and validation path. The current draft is strong enough for agent orientation and controlled internal use; certification still requires a live run or documented manual evidence.

## When to Use

Use this workflow when the trigger occurs: **Immediate agency setup; monthly thereafter**.
...
1. Confirm the trigger: Immediate agency setup; monthly thereafter.
...
- `trackers/CUL-08_Tech_Stack_Registry.xlsx`: binary attachment retained outside the Markdown kit; convert to CSV/Markdown during certification if the sheet contents become authoritative.
