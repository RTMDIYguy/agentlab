...
const INITIAL_NOTIFICATIONS: NotificationItem[] = [
  {
    ...
    description: 'Auditor-Bot-9 encountered a read timeout connecting to read-only database host.',
    timestamp: '12m ago',
  ...
  },
  {
    ...
    description: 'SDR-Scraper-02 received a 429 backoff warning from origin domain. Swarm throttled.',
    timestamp: '25m ago',
  ...
  },
  {
    ...
    description: 'System Orchestrator synthesized DAG proposal WFP-2026-08 for lead enrichment.',
    timestamp: '42m ago',
  ...
  },
  {
    ...
    description: 'Alpha-Node-01 successfully enriched and verified 48 executive contacts.',
    timestamp: '2h ago',
  ...
  },
  {
    ...
    description: 'Total daily token spend is $14.28, remaining well below the $50.00 ceiling.',
    timestamp: '4h ago',
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2">
                        <h4 className={`text-xs font-semibold font-poppins truncate ${notif.isRead ? 'text-slate-300' : 'text-white'}`}>
                          {notif.title}
                        </h4>
                        {!notif.isRead && (
