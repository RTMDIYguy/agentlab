...
export const AgentSlideOver: React.FC<AgentSlideOverProps> = ({
  agent,
  onClose,
}) => {
          ...
          <div>
            <div className="flex items-center gap-3 mb-1">
              <span className="relative flex h-3 w-3">
                ...
                <span
                  className={`relative inline-flex rounded-full h-3 w-3 ${statusColors[agent.status]}`}
                ></span>
              </span>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8">
            ...
            <div className="bg-navy-950/50 p-4 rounded-xl border border-navy-800/50 space-y-4">
              <div>
                ...
                <div className="w-full bg-navy-800 rounded-full h-1.5">
                  <div
                    className="bg-cyan-500 h-1.5 rounded-full shadow-cyan-glow"
                    style={{ width: "99.4%" }}
                  ></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between text-xs mb-2">
                  ...
                  <span className="text-amber-400 font-mono">240ms</span>
                </div>
                <div className="w-full bg-navy-800 rounded-full h-1.5">
                  <div
          ...
          <div className="space-y-4 pb-6">
            ...
            <div className="bg-black border border-navy-800 rounded-lg p-4 font-mono text-xs text-green-400/90 leading-loose overflow-hidden">
              ...
              <div>
                [14:02:45.991] <span className="text-cyan-400">EXEC</span>:
                Received payload block 0xA89F.
              </div>
              <div>[14:03:12.112] INFO: Processing constraints verified.</div>
              <div>
                [14:04:00.005] <span className="text-amber-400">WARN</span>:
                Memory threshold approaching 80%.
              </div>
