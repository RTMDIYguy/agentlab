...
export const Agents: React.FC = () => {
  const [agents, setAgents] = useState<Omit<AgentCardProps, 'onClick' | 'onAction'>[]>([]);
    ...
    <div className="flex flex-col space-y-8 animate-in fade-in duration-500 relative">
      ...
      {isLoading ? (
        <div className="flex flex-col items-center justify-center py-20 bg-navy-900/30 rounded-2xl border border-navy-800/80">
          ...
          <p className="text-slate-300 font-inter text-sm font-medium">Loading swarm nodes & telemetry...</p>
          <p className="text-slate-500 font-mono text-xs mt-1">Connecting to Cloud Run orchestrator</p>
        </div>
