  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-3">
        ...
        <span
          className={`px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wider rounded-full border ${statusStyles[status]}`}
        >
          {status}
        </span>
      </div>
      <p className="font-inter text-sm text-slate-400 mb-6 flex-grow">
        {description}
      </p>
