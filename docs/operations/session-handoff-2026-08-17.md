...
1.  **Paste Your HubSpot App Token:**
    ...
    - Replace `pat-your-token-here` with your actual HubSpot Private App Access Token (starts with `pat-`, retrieved from _HubSpot Settings > Integrations > Private Apps_).
