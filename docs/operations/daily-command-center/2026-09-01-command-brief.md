# Daily Command Brief - 2026-09-01
...
- CC-2026-08-29-001 Auth / Architecture / Marketplace: Deprecated Firebase auth and implemented native backend JWT auth + Google AI Studio sessions; reconciled hosting vs marketing domain architecture (agent-lab.tech & agent-lab.me on Ionos, SaaS runtime on Cloud Run/Vercel); updated Marketplace with live apps (Market Marksman, Pulse Social, LeadPulse, Founder Signal System), authority books, and playbooks.
