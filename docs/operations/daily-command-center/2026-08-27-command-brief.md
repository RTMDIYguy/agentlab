# Daily Command Brief - 2026-08-27
...
- CC-2026-06-04-011 Operations / Bootstrapper.ai Microsoft Nylas Sync Error: Updated the Bootstrapper.ai field guide with the Microsoft email/calendar sync error details from Nylas: Status 31004, integration_not_found, Error During OAuth, host api.us.nylas.com, plus a developer note summarizing both Microsoft/Nylas and Google OAuth blockers.
- CC-2026-06-04-012 Marketing / Agent Lab Content Queue Health Correction: Corrected the Daily Command Center running-test note from healthy to needs refill for Agent Lab LinkedIn content queue health.
