...
This file tracks prompt and harness changes for MKT-06 agents.

## Rule

Update this file whenever an agent prompt, model, harness contract, stop
condition, telemetry requirement, or tool permission changes.
