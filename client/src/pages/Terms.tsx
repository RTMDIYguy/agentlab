        ...
        <div className="prose prose-invert max-w-none space-y-6 text-foreground">
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              and agree to be bound by and comply with these Terms and
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-3">
              ...
              materials (information or software) on AgentLab's website for
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              The materials on AgentLab's website are provided on an 'as is'
              basis. AgentLab makes no warranties, expressed or implied, and
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              In no event shall AgentLab or its suppliers be liable for any
              damages (including, without limitation, damages for loss of data
              or profit, or due to business interruption) arising out of the use
              or inability to use the materials on AgentLab's website, even if
              AgentLab or an authorized representative has been notified orally
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              technical, typographical, or photographic errors. AgentLab does
              not warrant that any of the materials on its website are accurate,
              complete, or current. AgentLab may make changes to the materials
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              AgentLab has not reviewed all of the sites linked to its website
              and is not responsible for the contents of any such linked site.
              The inclusion of any link does not imply endorsement by AgentLab
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              AgentLab may revise these terms of service for its website at any
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-3">
              ...
              any way that violates these Terms and Conditions. Specifically,
              you agree not to:
            </p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              images, and software, is the property of AgentLab or its content
              suppliers and is protected by international copyright laws. You
              may not reproduce, distribute, or transmit any content without our
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-3">
              By subscribing to our services, you agree to pay the subscription
              fee as displayed on our website. Subscription fees are billed in
              advance on a recurring basis. You may cancel your subscription at
              any time through your account settings. Refunds are not provided
