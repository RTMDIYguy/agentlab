        ...
        <div className="prose prose-invert max-w-none space-y-6 text-foreground">
          <section>
            ...
            <p className="text-muted-foreground">
              AgentLab ("we," "us," "our," or "Company") is committed to
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              <li>
                ...
                number, billing address, and other information you voluntarily
                provide
              </li>
              <li>
                <strong>Payment Information:</strong> Credit card details
                processed securely through Stripe (we do not store full card
                numbers)
              </li>
              <li>
                <strong>Usage Data:</strong> Browser type, IP address, pages
                visited, time spent on pages, and referral sources
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              <li>
                ...
                assist in operating our website and conducting our business
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              please see our Cookies Policy. You can control cookie preferences
