  ...
  const faqs = [
    {
      ...
      answer:
        "Getting started with AgentLab is simple. Sign up for an account, choose a pricing plan that fits your needs, and follow our onboarding guide. You'll have access to our documentation and can deploy your first AI agent within minutes.",
    },
    {
      category: "getting-started",
      question: "What are the system requirements?",
      answer:
        "AgentLab is a cloud-based platform, so you only need a modern web browser and an internet connection. We support Chrome, Firefox, Safari, and Edge on both desktop and mobile devices.",
    },
    {
      category: "getting-started",
    ...
    },
    {
      ...
      answer:
        "We accept all major credit cards (Visa, Mastercard, American Express) and wire transfers for enterprise customers. Payments are processed securely through Stripe.",
    },
    {
      category: "billing",
      question: "Can I change my plan anytime?",
      answer:
        "Yes, you can upgrade or downgrade your plan at any time. Changes take effect at the start of your next billing cycle. If you upgrade, you'll be prorated for the difference.",
    },
    {
      category: "features",
      question: "What AI capabilities does AgentLab provide?",
      answer:
        "AgentLab provides advanced AI capabilities including natural language processing, machine learning, multi-agent coordination, real-time processing, and enterprise security. Our agents can be customized for your specific business needs.",
    },
    {
      category: "features",
      question: "Can I integrate AgentLab with other tools?",
      answer:
        "Yes, AgentLab offers extensive integration capabilities with popular business tools including Slack, Microsoft Teams, Salesforce, HubSpot, and more. We also provide a comprehensive API for custom integrations.",
    },
    {
      category: "security",
      question: "How secure is AgentLab?",
      answer:
        "AgentLab is built with enterprise-grade security including end-to-end encryption, SOC 2 compliance, GDPR compliance, and regular security audits. Your data is stored in secure, redundant data centers.",
    },
    {
      category: "security",
      question: "What happens to my data if I cancel?",
      answer:
        "When you cancel your account, your data is retained for 30 days. You can request a data export at any time. After 30 days, all data is permanently deleted from our servers.",
    },
    {
      category: "support",
      question: "What support options are available?",
      answer:
        "We offer 24/7 email support for all plans, live chat for Professional and Enterprise plans, and phone support for Enterprise customers. Response times vary based on your plan.",
    },
    {
      category: "support",
      question: "Is there documentation available?",
      answer:
        "Yes, we have comprehensive documentation including getting started guides, API documentation, code examples, and video tutorials. All documentation is available in our knowledge base.",
    },
    {
      category: "support",
      question: "How do I report a bug?",
      answer:
        "You can report bugs through our support portal, email, or live chat. Please include as much detail as possible including steps to reproduce, expected behavior, and actual behavior.",
    },
  ];
            ...
            <div className="mt-6 bg-white rounded-lg border border-border shadow-lg p-6 min-h-96">
              <div className="flex flex-col items-center justify-center h-full text-center">
                ...
                <p className="text-muted-foreground mb-2">
                  Chat widget will appear here once configured with your Crisp
                  Website ID
                </p>
                <p className="text-sm text-muted-foreground">
                  To enable live chat, update the CRISP_WEBSITE_ID in the
                  LiveChat component with your actual Crisp website ID
                </p>
                <LiveChat />
              </div>
            </div>
              ...
              <Card className="p-6 border border-border">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      info@unclerobertconsulting.com
                    </p>
