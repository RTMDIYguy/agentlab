        ...
        <div className="prose prose-invert max-w-none space-y-6 text-foreground">
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              your browser or the hard drive of your computer. Cookies contain
              information that is transferred to your computer's hard drive. We
              use cookies to improve your experience on our website and to
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  our website cannot function properly.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  website, such as which pages are visited most often, and
                  whether visitors receive error messages. These cookies do not
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  in order to make advertising relevant to you and your
                  interests. They remember that you have visited a website and
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  browser. They are used to maintain your session and keep you
                  logged in while you navigate our website.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              ...
              <li>
                ...
                set period (typically 1-2 years)
              </li>
              <li>
                <strong>Authentication Cookies:</strong> Remain until you log
                out or for a specified period
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-3">
              ...
              not be able to use the full functionality of our website. Here are
              your options:
            </p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              <li>
                ...
                cookies and alert you when cookies are being sent
              </li>
              <li>
                <strong>Opt-Out:</strong> You can opt out of certain third-party
                cookies by visiting the opt-out pages of the relevant service
                providers
              </li>
              <li>
                <strong>Do Not Track:</strong> Some browsers include a "Do Not
                Track" feature. Our website currently does not respond to Do Not
                Track signals
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              ...
              <li>
                ...
                → Cookies and other site permissions
              </li>
            </ul>
          </section>
            ...
            <div className="space-y-3">
              <div className="p-3 bg-card rounded border border-border">
                ...
                <p className="text-sm text-muted-foreground">
                  Used to maintain your login session and user preferences
                </p>
              </div>
              <div className="p-3 bg-card rounded border border-border">
                ...
                <p className="text-sm text-muted-foreground">
                  Used to track website usage and improve user experience
                </p>
              </div>
              <div className="p-3 bg-card rounded border border-border">
                <p className="font-semibold text-foreground">
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              We use cookies based on the following legal grounds: (1) your
              consent, (2) performance of our contract with you, (3) compliance
              with legal obligations, and (4) our legitimate interests in
              improving our services and understanding user behavior.
            </p>
          </section>
