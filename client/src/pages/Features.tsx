    ...
    workflows: [
      {
        ...
        description:
          "Automatically identify and qualify leads from multiple sources",
      },
      {
        name: "Email & SMS Nurture",
        description:
          "Intelligent email and SMS campaigns that adapt to customer behavior",
      },
      {
        name: "Polls & Assessments",
        description: "Create and analyze customer surveys and assessments",
      },
      {
        name: "Content Marketing",
        description: "AI-assisted content creation and distribution",
      },
      {
        name: "Social Media",
      ...
      },
      {
        ...
        description: "Optimize ad spend across platforms with AI",
      },
    ],
    tiers: {
      basic: {
    ...
    workflows: [
      {
        ...
        description: "Automated deal tracking and pipeline optimization",
      },
      {
        name: "Lead Scoring",
      ...
      },
      {
        ...
        description: "Predictive analytics for accurate sales forecasts",
      },
      {
        name: "Proposal Generation",
        description: "Automated proposal creation and personalization",
      },
      {
        name: "Contract Management",
        description: "Streamlined contract creation and e-signature",
      },
      {
        name: "Commission Tracking",
        description: "Automated commission calculation and reporting",
      },
    ],
    tiers: {
      basic: {
  ...
  operations: {
    ...
    workflows: [
      ...
      },
      {
        ...
        description: "Automated vendor communication and performance tracking",
      },
      {
        name: "Quality Assurance",
        description: "Continuous quality monitoring and reporting",
      },
      {
        name: "Resource Planning",
        description: "Intelligent resource allocation and scheduling",
      },
      {
  ...
  finance: {
    ...
    workflows: [
      ...
      },
      {
        ...
        description: "Intelligent invoicing and payment collection",
      },
      {
        name: "Expense Management",
        description: "Automated expense tracking and reimbursement",
      },
      {
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Choose your department and select the workflows that match your
              business needs. Mix and match to build your perfect solution.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-br from-white via-blue-50/30 to-white">
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {(["basic", "professional", "enterprise"] as Tier[]).map(
              tier_key => {
          ...
          <div className="text-center">
            <p className="text-muted-foreground mb-6">
              Want to combine multiple departments? Go to our pricing page to
